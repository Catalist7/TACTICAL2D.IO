...
gen-level-tests gen-validate tutorial-tests hints-tests armor-tests fx-tests bot-tests upgrade-tests props-tests decay-tests squad-tests options-tests admin-tests barrel-tests \
