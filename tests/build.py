...
SUITES = {
    ...
    'armor-tests': 'prelude-dom', 'fx-tests': 'prelude-dom', 'bot-tests': 'prelude-dom', 'upgrade-tests': 'prelude-dom', 'props-tests': 'prelude-dom', 'decay-tests': 'prelude-dom', 'squad-tests': 'prelude-dom', 'integration-tests': 'prelude-dom',
